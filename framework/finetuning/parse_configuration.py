...
class ParsePEFTConfig:
    @staticmethod
    def register_parameters(**kwargs):
        parser = argparse.ArgumentParser(description='PEFT Protein Annotation Framework')
        parser.add_argument(
            '--data_path',
            type=str,
        ...
        parser.add_argument('--is_save_batch', type=bool, default=True, help='whether to save model in each batch')
