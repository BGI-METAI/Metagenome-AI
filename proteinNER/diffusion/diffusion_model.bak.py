...
from proteinNER.diffusion.losses import normal_kl, discretized_gaussian_log_likelihood
...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None):
        ...
        Args:
            ...
            x: the [B x L x C] tensor at time t.
            t: a 1-D Tensor of timestep.
        ...
        """
        model_output = model(x, self._scale_timestep(t))
    ...
    def _scale_timestep(self, t):
        return t.float() * (1000. / self.num_timestep)
    ...
    def p_sample_loop(self, model, shape, noise=None, clip_denoised=True, denoised_fn=None, device=None,
                      progress=False):
        """
        ...
        Args:
            ...
            shape: the shape of the samples, (B, L, C).
    ...
    def p_sample_loop_progressive(self, model, shape, noise=None, clip_denoised=True, denoised_fn=None, device=None,
                                  progress=False):
        """
        ...
        indices = list(range(self.num_timestep))[::-1]
    ...
    def _prior_bpd(self, x_start):
        ...
        t = torch.tensor([self.num_timestep - 1] * batch_size, device=x_start.device)
    ...
    def calc_bpd_loop(self, model, x_start, clip_denoised=True):
        ...
        xstart_mse = []
        mse = []
        for t in list(range(self.num_timestep))[::-1]:
