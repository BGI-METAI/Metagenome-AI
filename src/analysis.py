...
class Analyser:
    ...
    def testing_models(self):
        ...
        model_order = ['PTRANS_MLP_3HL', 'PTRANS_XGBoost', 'EMS2_650M_MLP_3HL', 'EMS2_650M_XGBoost', 'EMS2_3B_MLP_3HL', 'EMS2_3B_XGBoost', 'ESM3_MLP_3HL', 'ESM3_XGBoost']
    ...
    def testing_models_single_metric(self):
        # amp_df = pd.read_excel('../data/predictions/ripp_lab_validation/AMP_test.xlsx', sheet_name='AMP')
        amp_df = pd.read_csv(self.metrics_table_path)
        #amp_df.head()
    ...
    def analyse(self):
        ...
        self.testing_models()
        # self.testing_models_single_metric()
